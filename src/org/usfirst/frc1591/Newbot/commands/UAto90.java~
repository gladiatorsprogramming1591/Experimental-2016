 ...
 *
 */
public class UAto90 extends Command {
    ...
    protected void initialize() {
    	Robot.leftArm.leftarmUp(0.5);
    	Robot.rightArm.rightarmUp(0.5);
    }
    ...
    protected boolean isFinished() {
        return (Robot.rightArm.maxHeight(0.52) || Robot.leftArm.maxHeight(0.53));
    }
