...
public class rightArm extends PIDSubsystem {
    ...
    private final SpeedController rightMotor = RobotMap.rightArmrightMotor;
    private final AnalogPotentiometer rightPot = RobotMap.rightArmrightPot;
    ...
    public rightArm() {
        ...
        super("rightArm", 40.0, 0.0, 0.0);
        setAbsoluteTolerance(0.005);
        getPIDController().setContinuous(false);
        LiveWindow.addActuator("rightArm", "PIDSubsystem Controller", getPIDController());
    ...
    public void rightarmDown(double speed){
    	rightMotor.set(-speed);
